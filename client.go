...
// APIClient manages communication with the openobserve API v0.14.5
...
type APIClient struct {
	...
	ShortUrlAPI *ShortUrlAPIService

	StreamsAPI *StreamsAPIService

	SyslogRoutesAPI *SyslogRoutesAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ShortUrlAPI = (*ShortUrlAPIService)(&c.common)
	c.StreamsAPI = (*StreamsAPIService)(&c.common)
	c.SyslogRoutesAPI = (*SyslogRoutesAPIService)(&c.common)
...
func (c *APIClient) prepareRequest(
	...
	if ctx != nil {
		...
		if auth, ok := ctx.Value(ContextAPIKeys).(BasicAuth); ok {
