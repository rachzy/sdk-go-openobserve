...
func (r ApiListClustersRequest) Execute() (*map[string][]string, *http.Response, error) {
...
func (a *ClustersAPIService) ListClustersExecute(r ApiListClustersRequest) (*map[string][]string, *http.Response, error) {
	var (
